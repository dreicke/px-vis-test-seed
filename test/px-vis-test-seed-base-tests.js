...
function runBaseTests() {
  px_vis_test_seed_1 = document.getElementById('px_vis_test_seed_1');

  suite('Base Automation Tests for px-vis-test-seed', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-test-seed fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_test_seed_1') !== null);
    });
